...
def _rget(url):
	...
	resp = requests.get(url, headers={'User-Agent': 'TUWien-OccupationTimelineBot/0.1 (student project; contact: e12433727@student.tuwien.ac.at)'})
...
def get_soup(title):
	...
	"""
	r = requests.get('https://en.wikipedia.org/wiki/{}'.format(title))
